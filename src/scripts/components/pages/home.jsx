...
Я не консультирую по здоровью и питанию, спортивной, нормативной, защитной дрессировке и не готовлю к выставкам.
        ...
        <Button id='question'>Как проходят занятия и консультации?</Button>
        <Accordeon id='second'>
...
Мы подбираем удобное время для проведения консультации. Время закрепляется за вами после внесения предоплаты в размере 100% от стоимости занятия или пакета занятий. В назначенное время мы созваниваемся в мессенджере.
        ...
        <Button id='question'>Сколько стоят занятия и консультации?</Button>
        <Accordeon id='second'>
...
Подробную информацию о каждом формате работы вы можете узнать в соответствующем разделе.<br  /> 
        ...
        <Button id='question'>Что может потребоваться в процессе работы?</Button>
        <Accordeon id='second'>
        В процессе работы от вас может потребоваться проверка здоровья собаки, а также смена амуниции.<br  /> 
        </Accordeon>
        <Button id='question'>С какого возраста следует начинать работу со щенком?</Button>
        <Accordeon id='second'>
        ...
        <Button id='question'>Есть ли смысл начинать работу уже со взрослой собакой?</Button>
        <Accordeon id='second'>
        В любом возрасте можно обучить собаку новому поведению или скорректировать имеющееся.<br  /> 
        </Accordeon>
        <Button id='question'>Есть ли породы с которыми бесполезно работать?</Button>
        <Accordeon id='second'>
        ...
        <Button id='question'>Что делать, если в ходе работы выяснится, что проблему невозможно решить?</Button>
        <Accordeon id='second'>
